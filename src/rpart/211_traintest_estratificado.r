...
particionar( dataset, division=c(7,3), agrupa="clase_ternaria", seed= 151153 )  #Cambiar por la primer semilla de cada uno !

#Semillas: 151153, 251207, 351293, 451327, 551377
