...
ksemillas  <- c(157717, 191791, 224743, 257603, 290527, 323507, 356563, 389527, 422549, 455573, 488599, 521641, 554639, 587659, 620717, 653707, 686843, 719839, 752891, 785903) #reemplazar por las propias semillas
...
setwd("C:/Users/manue/OneDrive/Documentos/Manuel/Maestria/3-DataMining/datasets")  #Establezco el Working Directory
#cargo los datos
